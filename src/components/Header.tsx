...
export default function Header() {
  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50 flex items-center justify-between px-6 py-6 md:px-12 bg-transparent text-black font-mono text-sm uppercase tracking-wide">
      {/* Logo */}
